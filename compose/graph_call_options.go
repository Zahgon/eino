...
func (c *graphCancelSignal) trigger(timeout *time.Duration) { _ = "STUB: not implemented"; return }
...
func getGraphCancel(ctx context.Context) *graphCancelSignal { _ = "STUB: not implemented"; return nil }
